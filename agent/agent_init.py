...
def init_agent(
    ...
    # Responses there. External-process runtimes are excluded:
    # CopilotACPClient and ClaudeCliClient handle their own routing and
    # do not implement the Responses API surface.
